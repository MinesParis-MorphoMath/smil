...
//     } 
    ...
    Image<UINT8> imOriginal8 = smil::Image<UINT8>("/home/afehri/Dropbox/Images/imTestPerso/shape_2.png"); 
    Image<UINT8>  imIn = smil::Image<UINT8>("/home/afehri/Dropbox/Images/imTestPerso/shape_2.png");
...
//     Dendrogram<UINT32,UINT32,UINT32>::HierarchicalDendrogramConstruction(dendroFromG2,"stochasticSurfacicImageReturn",100,imMosaic2,"erode");
    Dendrogram<UINT32,UINT32,UINT32>::HierarchicalDendrogramConstruction(dendroFromG2,"stochasticSurfacic",100,imMosaic2,"erode",HexSE());
