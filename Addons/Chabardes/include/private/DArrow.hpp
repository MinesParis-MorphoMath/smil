...
*/                    andl (out, finaland, S[0], out);
    ...
    RES_T arrowComplement (const Image<T1> &_im_, Image<T2> &_out_, const StrElt &s)
    {
        ...
        vector<UINT> inverses; generateInverses (inverses, se);
    ...
    class binaryMorphArrowImageFunction : public MorphImageFunction<T_in, lineFunction_T, T_out>
    {
    public:
        ...
        binaryMorphArrowImageFunction(T_in border=numeric_limits<T_in>::min(), T_out /*_initialValue*/ = ImDtTypes<T_out>::min()) 
          : MorphImageFunction<T_in, lineFunction_T, T_out>(border) 
        {
        }
        virtual RES_T _exec_single(const imageInType &imIn, const imageInType &imIn2, imageOutType &imOut, const StrElt &se);
    };


    template <class T_in, class lineFunction_T, class T_out>
    RES_T binaryMorphArrowImageFunction<T_in, lineFunction_T, T_out>::_exec_single(const imageInType &imIn, const imageInType &imIn2, imageOutType &imOut, const StrElt &se)
    {
    ...
    {
        binaryMorphArrowImageFunction<T_in, lowSupLine<T_in, T_out>, T_out > iFunc(borderValue);
    ...
    {
        binaryMorphArrowImageFunction<T_in, lowOrEquSupLine<T_in, T_out>, T_out > iFunc(borderValue);
        return iFunc._exec_single(imIn, imIn2, imOut, se);
    }
    ...
    {
        binaryMorphArrowImageFunction<T_in, grtSupLine<T_in, T_out>, T_out > iFunc(borderValue);
        return iFunc._exec_single(imIn, imIn2, imOut, se);
    }
    ...
    {
        binaryMorphArrowImageFunction<T_in, grtOrEquSupLine<T_in, T_out>, T_out > iFunc(borderValue);
        return iFunc._exec_single(imIn, imIn2, imOut, se);
    }
    ...
    {
        binaryMorphArrowImageFunction<T_in, equSupLine<T_in, T_out>, T_out > iFunc(borderValue);
        return iFunc._exec_single(imIn, imIn2, imOut, se);
    }
