...
namespace smil
{
  namespace graphalgo
  {
    ...
    RES_T GeoCuts_Regularized_MinSurfaces(
        const Image<T> &imIn, const Image<T> &imGrad,
        const Image<T> &imCurvature, const Image<T> &imMarker,
     ...
     */
    template <class T>
    RES_T MAP_MRF_Ising(const Image<T> &imIn,
                               const Image<T> &imMosaic,
                               const Image<T> &imMarker,
     ...
     */
    template <class T>
    RES_T MAP_MRF_edge_preserving(const Image<T> &imIn,
                                         const Image<T> &imMosaic,
                                         const Image<T> &imMarker,
                                         const CVariant &Beta,
                                         const CVariant &Sigma,
                                         const StrElt &nl,
                                         Image<T> &imOut);
     ...
     */
    template <class T>
    RES_T MAP_MRF_Potts(const Image<T> &imIn,
                               const Image<T> &imMosaic,
                               const Image<T> &imMarker,
                               const CVariant &Beta, const CVariant &Sigma,
                               const StrElt &nl,
