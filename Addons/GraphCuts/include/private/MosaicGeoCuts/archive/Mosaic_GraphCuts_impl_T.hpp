#ifndef MOSAIC_GRAPHCUTS_IMPL_T_HPP
#define MOSAIC_GRAPHCUTS_IMPL_T_HPP
        ...
        if (label > 0) {
          ...
          for (nit = neighb.begin(), nend = neighb.end(); nit != nend; ++nit) {
            ...
            if (o2 > o1) {
              ...
              if (label != label2) {
                typename ImageVal::value_type val_o2 =
                    imVal.pixelFromOffset(o2);
...
#endif // MOSAIC_GRAPHCUTS_IMPL_T_HPP
