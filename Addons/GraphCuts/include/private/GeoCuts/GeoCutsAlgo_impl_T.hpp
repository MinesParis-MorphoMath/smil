...
namespace morphee
{
  namespace graphalgo
  {
    ...
    RES_C t_ParametricGeoCuts(const ImageIn &imIn, const ImageGradx &imGradx,
                              const ImageGrady &imGrady,
                              const ImageMarker &imMarker, const SE &nl,
                              ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_ParametricGeoCuts");

      std::cout << "Enter function t_ParametricGeoCuts" << std::endl;
    ...
    template <class ImageIn, class ImageMarker, class ImageMarker2, class SE,
              class ImageOut>
    RES_C t_GeoCuts_Boundary_Constrained_MinSurfaces(
        const ImageIn &imIn, const ImageMarker &imMarker,
        const ImageMarker2 &imMarker2, const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Boundary_Constrained_MinSurfaces");
    ...
    RES_C t_GeoCuts_Stochastic_Watershed_Graph(const ImageIn &imIn,
                                               const ImageVal &imVal,
                                               BoostGraph &Gin,
                                               const _nbmarkers nbmarkers,
                                               const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Stochastic_Watershed_Graph");
    ...
    template <class ImageIn, class ImageVal, class BoostGraph,
              typename _nbmarkers, class SE, class ImageOut>
    RES_C t_GeoCuts_Stochastic_Watershed_Graph_NP(const ImageIn &imIn,
                                                  const ImageVal &imVal,
                                                  BoostGraph &Gin,
                                                  const _nbmarkers nbmarkers,
                                                  const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Stochastic_Watershed_Graph_NP");
    ...
    RES_C t_GeoCuts_Stochastic_Watershed_Variance(const ImageIn &imIn,
                                                  ...
                                                  const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Stochastic_Watershed");
    ...
    RES_C t_GeoCuts_MinSurfaces(const ImageIn &imIn,
                                const ImageMarker &imMarker, const SE &nl,
                                ImageOut &imOut)
    {
    ...
    template <class ImageIn, class ImageVal, typename _nbmarkers, class SE,
              class ImageOut>
    RES_C t_GeoCuts_Stochastic_Watershed(const ImageIn &imIn,
                                         const ImageVal &imVal,
                                         const _nbmarkers nbmarkers,
                                         const SE &nl, ImageOut &imOut)
    {
    ...
    template <class ImageIn, class ImageVal, class ImageMark,
              typename _nbmarkers, class SE, class ImageOut>
    RES_C t_GeoCuts_Stochastic_Watershed_2(const ImageIn &imIn,
                                           const ImageVal &imVal,
                                           const ImageMark &imMark,
                                           const _nbmarkers nbmarkers,
                                           const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Stochastic_Watershed_2");
    ...
    template <class ImageIn, class ImageMarker, typename _Power, class SE,
              class ImageOut>
    RES_C t_GeoCuts_Watershed_MinCut(const ImageIn &imIn,
                                     const ImageMarker &imMarker,
                                     const _Power Power, const SE &nl,
                                     ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Watershed_MinCut");
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_Watershed_Prog_MinCut(const ImageIn &imIn,
                                          const ImageMarker &imMarker,
                                          const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Watershed_Prog_MinCut");

      std::cout << "Enter function GeoCuts_Watershed_Prog_MinCut" << std::endl;
    ...
    template <class ImageIn, class ImageMarker, typename _Power, class SE,
              class ImageOut>
    RES_C
    t_GeoCuts_Watershed_SPF(const ImageIn &imIn, const ImageMarker &imMarker,
                            const _Power Power, const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Watershed_SPF");
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_Max_Fiability_Forest(const ImageIn &imIn,
                                         const ImageMarker &imMarker,
                                         const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Max_Fiability_Forest");

      std::cout << "Enter function t_GeoCuts_Max_Fiability_Forest" << std::endl;
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_BiCriteria_Shortest_Forest(const ImageIn &imIn,
                                               const ImageMarker &imMarker,
                                               const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_BiCriteria_Shortest_Forest");

      std::cout << "Enter function t_GeoCuts_BiCriteria_Shortest_Forest"
                << std::endl;
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_Lexicographical_Shortest_Forest(const ImageIn &imIn,
                                                    const ImageMarker &imMarker,
                                                    const SE &nl,
                                                    ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Lexicographical_Shortest_Forest");

      std::cout << "Enter function t_GeoCuts_Lexicographical_Shortest_Forest"
                << std::endl;
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_Vectorial_Lexicographical_Shortest_Forest(
        const ImageIn &imIn, const ImageMarker &imMarker, const SE &nl,
        ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION(
          "t_GeoCuts_Vectorial_Lexicographical_Shortest_Forest");
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_Vectorial_Shortest_Forest(const ImageIn &imIn,
                                              const ImageMarker &imMarker,
                                              const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Vectorial_Shortest_Forest");

      std::cout << "Enter function t_GeoCuts_Vectorial_Shortest_Forest"
                << std::endl;
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_Watershed_SpanningForest(const ImageIn &imIn,
                                             const ImageMarker &imMarker,
                                             const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Watershed_SpanningForest");

      std::cout << "Enter function t_GeoCuts_Watershed_SpanningForest"
                << std::endl;
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_Watershed_SpanningForest_v2(const ImageIn &imIn,
                                                const ImageMarker &imMarker,
                                                const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Watershed_SpanningForest_v2");

      std::cout << "Enter function t_GeoCuts_Watershed_SpanningForest_v2"
                << std::endl;
    ...
    template <class ImageIn, class ImageMarker, class SE, class ImageOut>
    RES_C t_GeoCuts_Reg_SpanningForest(const ImageIn &imIn,
                                       const ImageMarker &imMarker,
                                       const SE &nl, ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Reg_SpanningForest");

      std::cout << "Enter function GeoCuts_SpanningForest" << std::endl;
    ...
    template <class ImageIn, class ImageMarker, typename _Power, class SE,
              class ImageOut>
    RES_C t_GeoCuts_Multiway_Watershed(const ImageIn &imIn,
                                       const ImageMarker &imMarker,
                                       const _Power Power, const SE &nl,
                                       ImageOut &imOut)
    {
      MORPHEE_ENTER_FUNCTION("t_GeoCuts_Multiway_Watershed");
