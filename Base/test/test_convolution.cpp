...
class Test_GaussianFilter : public TestCase
{
  virtual void run()
  {
	...
	192, 133,  13,  15,   4, 135,  61, 254,  36, 173,
      ...
      UINT8 vecTruth[] = 
      {
	  34,  49,  57,  66,  66,  73,  87,  84,  70,  56,
	  54,  83,  94, 108, 115, 117, 125, 120, 104,  84,
	  69, 100, 114, 135, 152, 143, 126, 115, 100,  79,
	  86, 104, 109, 126, 141, 132, 111, 103,  88,  66,
	  74,  78,  66,  66,  77,  82,  82,  83,  71,  53,
      };
      im3 << vecTruth;
