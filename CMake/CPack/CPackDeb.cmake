...
IF(CPACK_DEBIAN_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DEPENDS)
      IF(CPACK_DEBIAN_PACKAGE_DEPENDS)
	    SET(CPACK_DEBIAN_PACKAGE_DEPENDS "${CPACK_DEBIAN_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DEPENDS}, ${CPACK_DEBIAN_PACKAGE_DEPENDS}")
      ELSE(CPACK_DEBIAN_PACKAGE_DEPENDS)
	    SET(CPACK_DEBIAN_PACKAGE_DEPENDS "${CPACK_DEBIAN_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DEPENDS}")
      ENDIF(CPACK_DEBIAN_PACKAGE_DEPENDS)
ENDIF(CPACK_DEBIAN_COMPONENT_${CPACK_DEB_PACKAGE_COMPONENT}_DEPENDS)
