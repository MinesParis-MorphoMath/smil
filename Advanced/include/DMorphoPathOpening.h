...
namespace smil
{
   ...
   * @param[out] takeMin : as the geodesic diameter is not increasing
   */
  template <class T1, class T2>
   ...
   * @param[in]  imCont the contrast image of the UPO
   * @param[in]  imInd : indicatrice image of the UPO
   * @param[out] return: a python list PatternSpect : Pattern Spectrum of the
   * image
   */
  template <class T1, class T2>
   ...
   * @param[out] imIndicatriceCorr the initial image filtred
   * @param[in] percentage :
   */
  template <class T1, class T2>
   ...
   * @param[in]  imIn the initial image (binary : 0, 255)
   * @param[in]  imIn the initial image (the skeleton associated)
   * @param[out] imOut the result : each CC have a value which correspond to the
   * eleongation of the CC
   */
  template <class T1, class T2>
   ...
   * of the skeleton
   * @param[in]  imIn the initial image
   * @param[in] stopAt : size max of the histogram
   * @param[out] return a boost::python::list with the histogram of size stopAt
   */
  template <class T>
