...
namespace morphee
{
  namespace FastLine
  {
    ...
    inline void BuildOpeningFromPoint(T1 F, int Ind, Node<T1bis> *MyStack,
    ...
    void EndProcess(Node<T1bis> *MyStack, int *stackSize, T2 *bufferOut)
    {
      while (*stackSize != 0) {
    ...
    int ComputeLinePosDiag_v2(T1 *bufferIn, int W, int H, int x, int y,
    ...
    template <class T1, typename T1bis, class T2>
    int ComputeBresenhamLinePX_v2(T1 *bufferIn, int W, int H, int x, int y,
    ...
    template <class T1, typename T1bis, class T2>
    int ComputeBresenhamLineNX_v2(T1 *bufferIn, int W, int H, int x, int y,
                                  int dx, int dy, Node<T1bis> *MyStack,
                                  int *stackSize, T2 *bufferOut)
    {
      int x0 = x, idx = y * W + x;
    ...
    template <class T1, typename T1bis, class T2>
    int ComputeBresenhamLinePY_v2(T1 *bufferIn, int W, int H, int x, int y,
                                  int dx, int dy, Node<T1bis> *MyStack,
                                  int *stackSize, T2 *bufferOut)
    {
      int y0, idx;
    ...
    template <class T1, typename T1bis, class T2>
    int ComputeBresenhamLineNY_v2(T1 *bufferIn, int W, int H, int x, int y,
                                  int dx, int dy, Node<T1bis> *MyStack,
                                  int *stackSize, T2 *bufferOut)
    {
      int y0, idx;
    ...
    void LineOpeningH_v2(T1 *bufferIn, int W, int H, int radius, T2 *bufferOut)
    {
      size = radius * 2 + 1;
    ...
    template <class T1, class T2>
    void LineOpeningV_v2(T1 *bufferIn, int W, int H, int radius, T2 *bufferOut)
    {
      size = radius * 2 + 1;
    ...
    template <class T1, class T2>
    void LineOpeningDiag_v2(T1 *bufferIn, int W, int H, int dx, int dy,
                            int radius, T2 *bufferOut)
    {
      size = radius * 2 + 1;
      int y, x, nx;
      ...
      if (abs(dx) == abs(dy)) {
        if (dx == -dy) {
          y = 0;
          do {
            nx = ComputeLineNegDiag_v2(bufferIn, W, H, 0, y++, MyStack,
                                       &stackPos, bufferOut);
            EndProcess(MyStack, &stackPos, bufferOut);
          } while (nx > 0);
          ...
          do {
            nx = ComputeLinePosDiag_v2(bufferIn, W, H, 0, y--, MyStack,
                                       &stackPos, bufferOut);
            EndProcess(MyStack, &stackPos, bufferOut);
          } while (nx > 0);
        }
    ...
    template <class T1, class T2>
    RES_C t_ImFastLineOpen_Morard(const Image<T1> &imIn, const int angle,
    ...
    // Specialisation of the algo for horizontal images
    template <class T1, class T2>
    RES_C t_ImFastLineOpeningH_v2(const Image<T1> &imIn, const int radius,
                                  Image<T2> &imOut)
    {
      // Check inputs
      if (!imIn.isAllocated() || !imOut.isAllocated()) {
